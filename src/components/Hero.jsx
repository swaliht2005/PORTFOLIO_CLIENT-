            ...
            <div className="container mx-auto px-6 z-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                >
                    ...
                    <div className="h-8 mb-8">
                        <h3 className="text-lg sm:text-xl md:text-2xl text-gray-300 font-medium max-w-lg mx-auto md:mx-0">
                            I am a <span className="text-[#ffbd39] border-r-2 border-[#ffbd39] pr-1.5 animate-pulse font-semibold">{currentText}</span>
                        </h3>
                    </div>
